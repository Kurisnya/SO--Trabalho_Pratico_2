...
int main(void)
{
    ...
    while (scanf("%d", &logical_address) == 1) {
         ...
         * MODIFICADO: Lógica de obtenção do número da página e do offset implementada.
         */
        // Desloca 8 bits para a direita para isolar os bits 15-8 e aplica a máscara 0xFF
